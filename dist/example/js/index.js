...
/* harmony import */ var _js_jquery_row_height_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../js/jquery.row_height.js */ "./src/js/jquery.row_height.js");
/* harmony import */ var _js_jquery_resize_events_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../js/jquery.resize_events.js */ "./src/js/jquery.resize_events.js");
...
})(jquery__WEBPACK_IMPORTED_MODULE_2__, window);
...
(function ($, window, undefined) {
  ...
  $[pluginName] = {
    ...
    run: function run(elements, options, deferred) {
      ...
      if (elements instanceof jquery__WEBPACK_IMPORTED_MODULE_11__) {
        $elements = elements;
      } else if (elements) {
        $elements = $(elements);
      }
  ...
  $.fn[pluginName] = function (arg1, arg2, arg3) {
    var rowHeight,
      ...
      _isOptions = function _isOptions(obj) {
        return _typeof(obj) === 'object' && (obj.nodeType === undefined || obj.nodeType !== 1) && obj instanceof jquery__WEBPACK_IMPORTED_MODULE_11__ === false;
      };
...
})(jquery__WEBPACK_IMPORTED_MODULE_11__, window);
